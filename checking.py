...
enc.load_weights('/root/deepfake/new_models/encoder.h5')
decoderA.load_weights('/root/deepfake/new_models/decoder_A.h5')
decoderB.load_weights('/root/deepfake/new_models/decoder_B.h5')
...
original_image = '/root/deepfake/trump\\3.jpg'
...
'''
original_image = '/root/deepfake/musk\\3.jpg'
read_image = cv2.imread(original_image)
...
#img = cv2.imwrite("/root/deepfake/new_thing.jpg", np.array(img))
plt.imsave('/root/deepfake/new_img.jpg', new_img)

#cv2.imwrite("/root/deepfake/new_image.jpg", new_img)
#if img == False:
