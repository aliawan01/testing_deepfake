...
enc.save_weights("C:\\Dev\\deepfake\\models\\encoder.h5")
...
decoderA.save_weights("C:\\Dev\\deepfake\\models\\decoder_A.h5")
print("Saved model to disk")
...
decoderB.save_weights("C:\\Dev\\deepfake\\models\\decoder_B.h5")
print("Saved model to disk")
'''
...
def save_weights():
    enc .save_weights('C:\\Dev\\deepfake\\models\\encoder.hdf5')
    decoderA.save_weights('C:\\Dev\\deepfake\\models\\decoder_A.h5')
    decoderB.save_weights('C:\\Dev\\deepfake\\models\\decoder_B.h5')
